...
export default function RegisterClient() {
  ...
  // limit. Security questions (which replace email-based "Forgot Password"
  // recovery, since there's no real address to send a link to) are set up
  // as a skippable step right after this, not collected here — keeps
  // account creation itself to the four fields that actually matter.
