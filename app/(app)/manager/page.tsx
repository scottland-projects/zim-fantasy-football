                    ...
                    <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: "auto", opacity: 1 }} exit={{ height: 0, opacity: 0 }}
                      ...
                      <div className="p-5 grid grid-cols-2 sm:grid-cols-3 gap-3">
                        <div><label className="text-xs font-medium text-muted-foreground mb-1 block">Home Team *</label>
                          <input value={fixtureForm.home} onChange={e => setFixtureForm(p => ({ ...p, home: e.target.value }))} placeholder="e.g. Harare Rangers" className="input text-sm py-2" /></div>
                        <div><label className="text-xs font-medium text-muted-foreground mb-1 block">Away Team *</label>
                          <input value={fixtureForm.away} onChange={e => setFixtureForm(p => ({ ...p, away: e.target.value }))} placeholder="e.g. Bulawayo Barons" className="input text-sm py-2" /></div>
